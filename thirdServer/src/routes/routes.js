...
const { getMeterInfoController, addMeterInfoController, addMeterInfoAfterClean, getDigitalMeterController, getLastMeterCLeanController } = require('../controllers/meterInfoController')
...
const { addRommtem } = require('../services/addRoomInfo')
