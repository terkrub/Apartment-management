...
const { getMeterInfoController, addMeterInfoController, addMeterInfoAfterClean, getLastMeterCLeanController } = require('../controllers/meterInfoController')
...
router.post("/getMeterAfterClean",authenMiddleware, getLastMeterCLeanController)
