  ...
  return (
    <div style={GenerateBillStyles.billcontainer}>
      <div ref={pdfContentRef}>
        ...
        <p style={GenerateBillStyles['billcontainer p']}>{branch?"888 หมู่ 15 ซอย ราชพิพัฒน์ 1 ถนนบ้านสามพร้าว อ.เมือง จ.อุดรธานี 41000":"358 หมู่ 15 ตำบลสามพร้าว อำเภอเมืองอุดรธานี จังหวัดอุดรธานี 41000"} <br/>{branch?"โทร.084-234-2222":"โทร. 0818275520 Email tertarkitty@hotmail.com ID Line tertarkitty"}</p>
        ...
        <div style={GenerateBillStyles['titleInfo-container']}>
          ...
          <div style={GenerateBillStyles['titleInfo-container']}>
            <p style={GenerateBillStyles['titleInfo-container .list2']}>ค่าประกันห้อง 5,000 บาท *ต้องเช่าอย่างน้อย 6 เดือน  </p>
            <p style={GenerateBillStyles['titleInfo-container .Meter']}></p>
            <p style={GenerateBillStyles['titleInfo-container .Meter']}></p>
            <p style={GenerateBillStyles['titleInfo-container .Meter']}></p>
          </div>
