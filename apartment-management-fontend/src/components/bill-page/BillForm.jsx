      ...
      {selectedOption && (
        ...
        {selectedBill === 'ค่าน้ำ ค่าไฟ' &&(
          <>
            ...
            {selectedOption.includes("C") ? <DigitalMeter roomNumber={"tb_kWh"+(parseInt(selectedOption.replace(/\D/g, ''))+2)} setCurrentEletricMeter={setCurrentEletricMeter} setCurrentMeter={setCurrentMeter} selectedBill={selectedBill}/>:""}
        ...
        {selectedBill === 'มิตเตอร์น้ำ ไฟ' &&(
          <>
            ...
            {selectedOption.includes("C") ? <DigitalMeter roomNumber={"tb_kWh"+(parseInt(selectedOption.replace(/\D/g, ''))+2)} setCurrentEletricMeter={setEletricMeter} selectedBill={selectedBill}/>:""}
